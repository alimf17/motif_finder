...
impl AllData {
    ...
    fn synchronize_sequence_and_data(pre_sequence: Vec<Option<usize>>, pre_data: Vec<Vec<(usize, f64)>>, pre_null_data: Vec<Vec<(usize, f64)>>, sequence_len: usize, spacing: usize) -> Result<(Sequence, NullSequence, WaveformDef, Vec<usize>, Vec<usize>), WaveCreationError> {
        ...
        Ok((seq, null_seq, wave_ret, starting_coords, null_starts_bps))
...
mod tests{
    ...
    fn see_data() {
        ...
        let (blocks, back, min_height, null_blocks) = AllData::process_data("/Users/afarhat/Downloads/GSE26054_RAW/GSM639836_TrpR_Trp_ln_ratio.pair", Ok(4641652), 498, 25, 3.0, true, None).unwrap();
