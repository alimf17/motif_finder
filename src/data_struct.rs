...
impl<'a> AllDataUse<'a> {
    ...
    //        This function automatically assumes a single chromosome
...
mod tests{
    ...
    fn see_data() {
        ...
        seq_lens.insert("".to_string(), 4641652);
        ...
        let (blocks, back, min_height, null_blocks, _) = AllData::process_data("/Users/afarhat/Downloads/GSM639836_TrpR_Trp_ln_ratio_headerless.bedgraph", Ok(seq_lens), 498, 25, 3.0, true, None, false).unwrap();

        //        // /Users/afarhat/Downloads/GSM639836_TrpR_Trp_ln_ratio_headerless.bedgraph

        println!("BAADS");


        for (i, bl) in blocks[0].1.iter().enumerate() {
            if bl.len() == 0 { 
        ...
        for null in null_blocks[0].1.iter() {
        ...
        // /Users/afarhat/Downloads/GSM639836_TrpR_Trp_ln_ratio_headerless.bedgraph
        let a = AllData::create_inference_data("/Users/afarhat/Downloads/sequence(1).fasta", "/Users/afarhat/Downloads/GSM639836_TrpR_Trp_ln_ratio_headerless.bedgraph", "/Users/afarhat/Desktop/", true,
