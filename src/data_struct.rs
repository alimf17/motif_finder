        ...
        match check_initialization {
            Ok(mut try_bincode) => {
                ...
                match attempted_data {
                    ...
                    Ok(mut data) => {
                        data.min_height = min_height.max(1.0);
                        match AllDataUse::new(&data, 0.0) {
                        ...
                        Err(_) => warn!("The file that your parameters point to produce a parsable set of data for inference, but the set
                                         ...
                                         but if this warning pops up, you likely need to change the size of your peak kernel or your blocks.
                                         This warning should not pop up if the file you're pointing to was generated by this in a prior run."),
                        }
                    },
                };
            }
            ...
            AllProcessingError::WayTooBig => {
                ...
                if cfg!(target_pointer_width = "32") {
                    ...
                    write!(f, "The combination of sequence and data ends up too large to store,
                               ...
                               with data files that large?? And WHO got the Nobel Prize for discovering 
...
mod tests{
    ...
    fn see_data() {
        ...
        let (blocks, back, min_height, null_blocks) = AllData::process_data("/Users/afarhat/Downloads/GSE26054_RAW/GSM639836_TrpR_Trp_ln_ratio.pair", Ok(4641652), 498, 25, 10, true, None).unwrap();
