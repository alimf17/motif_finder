...
mod tests{
    ...
    fn see_data() {
        ...
        let (blocks, back, null_blocks) = AllData::process_data("/Users/afarhat/Downloads/GSE26054_RAW/GSM639836_TrpR_Trp_ln_ratio.pair", Ok(4641652), 498, 25, true, None).unwrap();
