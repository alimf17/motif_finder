...
impl AllData {
    ...
    fn process_data(data_file_name: &str, possible_sequence_len: Result<usize, FastaError>, fragment_length: usize, spacing: usize, is_circular: bool, is_ar: bool, scale_peak_thresh: Option<f64>) -> Result<(Vec<Vec<(usize, f64)>>, Background), AllProcessingError> {
        ...
        let data_zone: usize = 100.max(fragment_length/spacing)*6;
...
mod tests{
    ...
    fn see_data() {
        ...
        let (blocks, back) = AllData::process_data("/Users/afarhat/Downloads/GSE26054_RAW/GSM639836_TrpR_Trp_ln_ratio.pair", Ok(4641652), 498, 25, true, false, None).unwrap();
        ...
        // /Users/afarhat/Downloads/GSE26054_RAW/GSM639836_TrpR_Trp_ln_ratio.pair
        let a = AllData::create_inference_data("/Users/afarhat/Downloads/sequence(1).fasta", "/Users/afarhat/Downloads/GSE26054_RAW/GSM639836_TrpR_Trp_ln_ratio.pair", "/Users/afarhat/Downloads/", true,
                                 498, 25, false, &None, None).unwrap();
        for (i, len) in a.0.seq.block_lens().into_iter().enumerate(){
            println!("{:?}", a.0.seq.return_bases(i, 0, len));
        }
