...
impl<'a> MotifSet<'a> {
    ...
    pub fn rand_with_one<R: Rng >(data_ref: &'a AllDataUse<'a>, rng: &mut R) -> Self {
    ...
    pub fn rand_with_one_height<R: Rng >(peak_height: f64, data_ref: &'a AllDataUse<'a>, rng: &mut R) -> Self {
    ...
    pub fn rand_with_one_height_and_motif_len<R: Rng >(peak_height: f64, motif_len: usize, data_ref: &'a AllDataUse<'a>, rng: &mut R) -> Self {
...
impl MotifSetDef {
    ...
    pub fn get_motif_set<'a, R: Rng >(self, recalculate: bool, validate_motifs: bool, randomizer: &mut Option<&mut R>, data_ref: &'a AllDataUse ) -> MotifSet<'a> {
...
impl<'a, R: Rng> SetTrace<'a, R> {
    ...
    pub fn new_trace(capacity: usize, initial_condition: Option<MotifSet<'a>>, data_ref: &'a AllDataUse<'a>, mut thermo_beta: f64, sparse: Option<usize>, mut rng: R) -> SetTrace<'a, R> {
    ...
    pub fn push_last_state_from_json(&mut self, always_recalculate: bool, validate_motif: bool,json_file: &str) {
        ...
        self.push_set_def(always_recalculate, validate_motif, prior_state);

    }

    pub fn push_last_state_from_bincode(&mut self, always_recalculate: bool, validate_motif: bool,bincode_file: &str) {
    ...
    pub fn push_set_def(&mut self, always_recalculate: bool,validate_motif: bool, set: MotifSetDef) {
        
        let mut validate_randomizer = if validate_motif { Some(&mut self.rng) } else {None};
    ...
    pub fn trace_from_meme(&mut self, meme_file_name: &str, seq: &Sequence, e_value_cutoff: f64) {
...
impl SetTraceDef {
    ...
    pub fn get_set_trace<'a, R: Rng >(mut self, data_ref: &'a AllDataUse, mut rng: R, sparse: Option<usize>) -> SetTrace<'a, R> {
        ...
        let last_state = match self.trace.pop() {
            ...
            None => {
                ...
                MotifSet::rand_with_one(data_ref, &mut rng)
            },
        };
...
impl<'a, R: Rng> TemperSetTraces<'a, R> {
